 ...
 * @property {CosmosBlockchainMeta} blockChain - The blockchain that this transaction will be executed in
...
export interface CosmosTransaction {
  ...
  blockChain: CosmosBlockchainMeta // TODO DOUBLE CHECK Probably Wrong
